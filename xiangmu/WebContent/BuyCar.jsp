...
<div class="i_bg">  
    ...
    <div class="content mar_20">
      ...
      <h1><a href="IndexQD.jsp" > 前去购物！	</a></h1>
  		</c:if>
        ...
        <c:forEach items="${cart.map}" var="cartItem">
          ...
          <tr> 
            <td>
                ...
                ${cartItem.key}${cartItem.value.product.name}
            </td>
            ...
            <td align="center"><a href="productServlet?method=del&id=${cartItem.key}">删除</a>&nbsp; &nbsp;<a href="#">加入收藏</a></td>
          </tr>
          ...
          <tr height="70">
          	<td colspan="6" style="font-family:'Microsoft YaHei'; border-bottom:0;">
                ...
                <span class="fr">商品总价：<b style="font-size:22px; color:#ff4e00;">￥${cart.price}</b></span>
            </td>
          </tr>
