...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，请<a href="LoginQD.jsp">登录</a>&nbsp; <a href="Regist.jsp" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
    ...
    <div class="content">
        ...
        <div class="pro_des" id="xiangdan">
            ...
            <div class="des_join">
                ...
                <%-- <span class="fl"><a href="javascript:addCart(${product.id})"><img src="images/j_car.png" /></a></span> --%>
            <a href="javascript:addCart(${product.id})">加入购物车</a>
            <a href="productServlet?method=findCart">查询购物车</a>
