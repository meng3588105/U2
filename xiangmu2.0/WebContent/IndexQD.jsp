			...
			$.ajax({
				...
				success:function(data){
					...
					$.each(
						...
						function(i,product){
							$("#idbuy")
								.append("<ul><li><div class=\"name\"><a href=\"productServlet?id="+product.id+"&method=findById\">"
										+product.name+
										"</a></div><div class=\"price\"><font>￥<span>"
										+product.price+
										"</span></font> &nbsp; 16R</div><div class=\"img\"><a href=\"productServlet?id="+product.id+"&method=findById\"><img src=\"images/make_5.jpg\" width=\"185\" height=\"155\" /></a></div></li></ul>")
